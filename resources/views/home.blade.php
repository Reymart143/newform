...
@section('content')
<div class="card" style="margin-left: 1% !important; margin-right: 1% !important">
<div class="container">
    ...
    <div class="row">
        <div class="col-12 table-responsive">
            <br/>
            <div align ="right">
                <button type="button" name="create_record" id="create_record" class="btn btn-primary"> <i class="bi bi-plus-square"></i>Add New User </button>
        </div>
    <br />
       
             <table class="table table-striped table-bordered " style = "background-color:#f5f5f5;" id="user_datatable">
            <thead>
                <tr>   
                    <th style="border: 1px solid #00000000;">Uploaded Photo</th>
                    <th style="border: 1px solid #00000000;">Full name</th>
                    <th style="border: 1px solid #00000000;">Birthdate</th>
                    <th style="border: 1px solid #00000000;">Age</th>
                    <th style="border: 1px solid #00000000;">Phone Number</th>
                    <th style="border: 1px solid #00000000;">Blood Type</th>
                    <th style="border: 1px solid #00000000;">Gender</th>
                    <th style="border: 1px solid #00000000;">Region</th>
                    <th style="border: 1px solid #00000000;">Province</th>
                    <th style="border: 1px solid #00000000;">Municipality</th>
                    <th style="border: 1px solid #00000000;">Barangay</th>
                    <th style="border: 1px solid #00000000;">Purok</th>
                    <th style="border: 1px solid #00000000;">Username</th>
                    <th style="border: 1px solid #00000000;">Current Location</th>
                    <th width="180px" style="border: 1px solid #00000000;">Action</th>
